...
const DepartmentDetailPage = () => {
  ...
  useEffect(() => {
    const fetchDepartment = async () => {
      ...
      const departments = [
        {
          id: "1",
          nombre: "Coastal Paradise",
          imagenes: [
            "https://www.infobae.com/resizer/v2/DCBSLNKANFF6TKGIDIMQDZOX6A.jpg?auth=10dadb63019f6a08cf136de989d9f586043d83d324856e75c332e7e7e46483da&smart=true&width=350&height=233&quality=85",
          ...
          distribucion: { Habitaciones: 3, Camas: 6, Baños: 2 },
          equipamiento: ["Horno", "Heladera", "Televisor", "Wifi"],
          servicios: [
  ...
  // const getIconForEquipment = (item) => {
        ...
        <Container className="py-4">
          ...
          >
            <Row className="justify-content-center">
              ...
              <Col xs={12} md={4} className="mb-4">
                <DetailCard department={department} attribute="servicios" />
              </Col>
            </Row>
          </div>
